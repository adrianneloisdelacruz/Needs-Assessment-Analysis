      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="row g-3" id="formB" method="post" action="main.php?action=needsassessmentB">
            ...
            <div class="col-md-4">
              <label for="inputRelationship" class="form-label">Relationship to the Household Head</label>
              <select id="inputRelationship" class="form-select" name="relationshiphouseholdhead" required>
                <option name="" disabled selected>Please Select</option>
                <option value="Household Head" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Household Head') {
                                                  echo "selected";
                                                } ?>>Household Head</option>
                <option value="Spouse" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Spouse') {
                                          echo "selected";
                                        } ?>>Spouse</option>
                <option value="Father" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Father') {
                                          echo "selected";
                                        } ?>>Father</option>
                <option value="Mother" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Mother') {
                                          echo "selected";
                                        } ?>>Mother</option>
                <option value="Daughter" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Daughter') {
                                            echo "selected";
                                          } ?>>Daughter</option>
                <option value="Son" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Son') {
                                      echo "selected";
                                    } ?>>Son</option>
                <option value="GrandDaughter" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'GrandDaughter') {
                                                echo "selected";
                                              } ?>>GrandDaughter</option>
                <option value="GrandSon" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'GrandSon') {
                                            echo "selected";
                                          } ?>>GrandSon</option>
                <option value="Brother" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Brother') {
                                          echo "selected";
                                        } ?>>Brother</option>
                <option value="Sister" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Sister') {
                                          echo "selected";
                                        } ?>>Sister</option>
                <option value="Aunt" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Aunt') {
                                        echo "selected";
                                      } ?>>Aunt</option>
                <option value="Uncle" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Uncle') {
                                        echo "selected";
                                      } ?>>Uncle</option>
                <option value="Friend" <?php if (isset($_POST['relationshiphouseholdhead']) && $_POST['relationshiphouseholdhead'] == 'Friend') {
                                          echo "selected";
                                        } ?>>Friend</option>
              </select>
            </div>
            ...
            <div class="col-4">
              ...
              <fieldset class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  <!-- <div class="form-check">
                      <input class="form-check-input" type="radio" name="gender" id="gridRadios3" value="lgbt"  <?php if (isset($_POST['gender']) && $_POST['gender'] == 'lgbt') {
                                                                                                                  echo  "checked";
                                                                                                                } ?> required>
            ...
            <div class="col-4">
              ...
              <fieldset class="row mb-4">
                <legend class="col-form-label col-sm-4 pt-0">Still Studying?</legend>
                <div class="col-sm-5">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="stillstudying" id="gridRadios1" value="yes" <?php if (isset($_POST['stillstudying']) && $_POST['stillstudying'] == 'yes') {
                                                                                                                      echo "checked";
                                                                                                                    } ?> checked>
                    <label class="form-check-label" for="gridRadios1">
                      Yes
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="stillstudying" id="gridRadios2" value="no" <?php if (isset($_POST['stillstudying']) && $_POST['stillstudying'] == 'no') {
                                                                                                                    echo "checked";
                                                                                                                  } ?>>
                    <label class="form-check-label" for="gridRadios2">
                      No
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="stillstudying" id="gridRadios2" value="na" <?php if (isset($_POST['stillstudying']) && $_POST['stillstudying'] == 'na') {
                                                                                                                    echo "checked";
                                                                                                                  } ?>>
                    <label class="form-check-label" for="gridRadios2">
                      Not Applicable
            ...
            <div class="col-md-4">
              ...
              <select id="inputEducation" class="form-select" name="education" required>
                <option selected>None</option>
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="inputMonthlyincome" name="monthlyincome" value="<?php if (isset($_POST['monthlyincome']) && $_POST['monthlyincome'] != '') {
                                                                                                            echo $_POST['monthlyincome'];
                                                                                                          } ?>" required>
            </div>
            <div class="col-md-4">
              ...
              <div class="col-sm-10">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="philhealth" id="gridRadios1" value="yes" <?php if (isset($_POST['philhealth']) && $_POST['philhealth'] == 'yes') {
                                                                                                                echo "checked";
                                                                                                              } ?> checked>
                  <label class="form-check-label" for="gridRadios1">
                    Yes
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="philhealth" id="gridRadios2" value="no" <?php if (isset($_POST['philhealth']) && $_POST['philhealth'] == 'no') {
                                                                                                                echo "checked";
                                                                                                              } ?>>
                  <label class="form-check-label" for="gridRadios2">
                    No
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="philhealth" id="gridRadios2" value="na" <?php if (isset($_POST['philhealth']) && $_POST['philhealth'] == 'na') {
                                                                                                                echo "checked";
                                                                                                              } ?>>
                  <label class="form-check-label" for="gridRadios2">
                    Not Applicable
            ...
            <div class="col-md-4">
              ...
              <div class="col-sm-10">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="election" id="gridRadios1" value="yes" <?php if (isset($_POST['election']) && $_POST['election'] == 'yes') {
                                                                                                              echo "checked";
                                                                                                            } ?> checked>
                  <label class="form-check-label" for="gridRadios1">
                    Yes
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="election" id="gridRadios2" value="no" <?php if (isset($_POST['election']) && $_POST['election'] == 'no') {
                                                                                                              echo "checked";
                                                                                                            } ?>>
                  <label class="form-check-label" for="gridRadios2">
                    No
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="election" id="gridRadios2" value="na" <?php if (isset($_POST['election']) && $_POST['election'] == 'na') {
                                                                                                              echo "checked";
                                                                                                            } ?>>
                  <label class="form-check-label" for="gridRadios2">
                    Not Applicable
            ...
            <div class="col-md-4">
              ...
              <div class="col-sm-10">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="taxpayer" id="gridRadios1" value="yes" <?php if (isset($_POST['taxpayer']) && $_POST['taxpayer'] == 'yes') {
                                                                                                              echo "checked";
                                                                                                            } ?> checked>
                  <label class="form-check-label" for="gridRadios1">
                    Yes
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="taxpayer" id="gridRadios2" value="no" <?php if (isset($_POST['taxpayer']) && $_POST['taxpayer'] == 'no') {
                                                                                                              echo "checked";
                                                                                                            } ?>>
                  <label class="form-check-label" for="gridRadios2">
                    No
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="taxpayer" id="gridRadios2" value="na" <?php if (isset($_POST['taxpayer']) && $_POST['taxpayer'] == 'na') {
                                                                                                              echo "checked";
                                                                                                            } ?>>
                  <label class="form-check-label" for="gridRadios2">
                    Not Applicable
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="inputMobile" name="mobileno" value="<?php if (isset($_POST['mobileno']) && $_POST['mobileno'] != '') {
                                                                                                echo $_POST['mobileno'];
                                                                                              } ?>" required>
            </div>
            <div class="text-center">
              ...
              <button type="reset" class="btn btn-success" id="resetB">Add Other Household Data</button>
              ...
              <a href="main.php?action=needsassessmentC&main_id=<?= $main_id ?>&bid=<?php echo $bid ?>"><input type="button" class="btn btn-warning" id="nextpageC" value="Next Page -> Section C"></a>
            </div>
