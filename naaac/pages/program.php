...
//$rst = mysqli_query($con, $sql);
  ...
  if (mysqli_num_rows($rst)!=0){
    ...
    $strkeyword = $row['program_keyword'];
...
if (isset($_REQUEST['submit']) && $tag='edit'){
 ...
 // $barangay = $_POST['barangay'];
  ...
  if (strlen($program_id)!=0){
      ...
      if (mysqli_num_rows($rst)!=0){
        $sql_update = "UPDATE program SET program_title='$programtitle',course_id='$courseid',string_keyword='$strkeyword',date_modified=CURRENT_TIMESTAMP WHERE program_id='$program_id'";
  ...
  if (isset($_REQUEST['submit']) && $tag='new'){
    ...
    $sql_insert = "INSERT INTO program (program_title,course_id,program_keyword,date_created) 
    VALUES ('$programtitle', '$courseid','$strkeyword',CURRENT_TIMESTAMP())";
...
?>
    ...
    <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="main.php?action=programlistresult">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" placeholder="Program Title" name="programtitle" value="<?php echo $programtitle;?>">
                    <label for="floatingName">Program Title</label>
                  </div>
                </div>
                ...
                <div class="text-center">
                  ...
                  <a href="main.php?action=programlist"><button type="button" class="btn btn-warning">Back</button></a>
                </div>
