...
$document = $phpWord->loadTemplate('template/project-proposalbsmath.docx');
$barangayname = "";
    ...
    <div class="row">
        ...
        <div class="col-xl-10 order-xl-2">  
            <section id="snippet-1" class="wrapper pt-6 pb-8">
                ...
                <h2 class="mb-5"><a href="main.php?action=needsassessment2proposalcs&projectid=<?php echo $projectid ?>&bid=<?php echo $barangay_id ?>"><i class="uil uil-angle-left"></i></a>Generate Proposal Docx File For BSMATH</h2>
                <div class="card">
